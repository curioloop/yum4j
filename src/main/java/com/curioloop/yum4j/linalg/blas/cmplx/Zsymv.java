...
interface Zsymv {
     ...
     */
    public static void zsymv(BLAS.Uplo uplo, int n, double alphaRe, double alphaIm,
        ...
        if (upper) {
            if (incX == 1 && incY == 1) {
                zsymvUpperUnitStride(n, alphaRe, alphaIm, A, aStart, lda, x, xStart, y, yStart);
            } else {
                zsymvUpperStride(n, alphaRe, alphaIm, A, aStart, lda, x, xStart, incX, y, yStart, incY);
            }
        } else {
            if (incX == 1 && incY == 1) {
                zsymvLowerUnitStride(n, alphaRe, alphaIm, A, aStart, lda, x, xStart, y, yStart);
            } else {
                zsymvLowerStride(n, alphaRe, alphaIm, A, aStart, lda, x, xStart, incX, y, yStart, incY);
            }
        }
    }

    static void zsymvUpperUnitStride(int n, double alphaRe, double alphaIm,
                                     double[] A, int aStart, int lda,
                                     double[] x, int xStart,
                                     double[] y, int yStart) {
        for (int i = 0; i < n; i++) {
            ...
            double diagIm = A[rowOff + i * 2 + 1];
            double sumRe = diagRe * xiRe - diagIm * xiIm;
            double sumIm = diagRe * xiIm + diagIm * xiRe;
    ...
    static void zsymvLowerUnitStride(int n, double alphaRe, double alphaIm,
                                     double[] A, int aStart, int lda,
                                     double[] x, int xStart,
                                     double[] y, int yStart) {
        for (int i = 0; i < n; i++) {
            ...
            double diagRe = A[rowOff + i * 2];
            double diagIm = A[rowOff + i * 2 + 1];
            sumRe = Math.fma(diagRe, xiRe, Math.fma(-diagIm, xiIm, sumRe));
            sumIm = Math.fma(diagRe, xiIm, Math.fma(diagIm, xiRe, sumIm));
    ...
    static void zsymvUpperStride(int n, double alphaRe, double alphaIm,
                                 double[] A, int aStart, int lda,
                                 double[] x, int xStart, int incX,
                                 double[] y, int yStart, int incY) {
        int xStep = incX * 2;
        ...
        for (int i = 0; i < n; i++) {
            ...
            double diagRe = A[rowOff + i * 2];
            double diagIm = A[rowOff + i * 2 + 1];
            double s0Re = diagRe * xiRe - diagIm * xiIm;
            double s0Im = diagRe * xiIm + diagIm * xiRe;
            double s1Re = 0.0;
            double s1Im = 0.0;
            ...
            for (; j < j2; j += 2) {
                ...
                updateSymvStride(y, yjOff, temp1Re, temp1Im, a0Re, a0Im);
                updateSymvStride(y, yjOff + yStep, temp1Re, temp1Im, a1Re, a1Im);
            ...
            for (; j < n; j++) {
                ...
                sumRe = Math.fma(aRe, xjRe, Math.fma(-aIm, xjIm, sumRe));
                sumIm = Math.fma(aRe, xjIm, Math.fma(aIm, xjRe, sumIm));
                updateSymvStride(y, yjOff, temp1Re, temp1Im, aRe, aIm);
                xjOff += xStep;
                yjOff += yStep;
            }
    ...
    static void zsymvLowerStride(int n, double alphaRe, double alphaIm,
                                 double[] A, int aStart, int lda,
                                 double[] x, int xStart, int incX,
                                 double[] y, int yStart, int incY) {
        int xStep = incX * 2;
    ...
    static void updateSymvStride(double[] y, int yOff, double temp1Re, double temp1Im, double aRe, double aIm) {
