...
/**
 * LAPACK ZLANHE: Computes the value of the one norm, or the Frobenius norm,
...
interface Zlanhe {
    ...
    /**
     * ZLANHE returns the value of the one norm, or the Frobenius norm,
     * or the infinity norm, or the element of largest absolute value of a complex
     * Hermitian matrix A.
     *
     ...
     * @param A     complex Hermitian matrix (n x n, row-major, interleaved format)
     * @param lda   leading dimension of A
     * @param work  workspace for norm '1' or 'I' (length n)
     * @return      the specified norm of A
     */
    static double zlanhe(char norm, BLAS.Uplo uplo, int n, double[] A, int lda, double[] work) {
        if (n == 0) {
            return 0.0;
        }
