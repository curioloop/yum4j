...
public final class KalmanSmoother {
        ...
        public static SmootherResult smooth(StateSpaceModel model,
                                            FilterResult fr) {
        ...
        static SmootherResult smoothInto(StateSpaceModel stateSpace,
        ...
        private static SmootherResult smoothInternal(StateSpaceModel stateSpace,
                                                                                                 StateSpaceModel observationModel,
                                                                                                 FilterResult fr,
                                                                                                 Pool pool,
        ...
        if (fr.nobsDiffuse > 0) {
            ...
            return smoothDiffuse(stateSpace, observationModel, fr, pool, smootherOutput, reuseResult, target);
                ...
                if (reuseResult && smootherOutput != SMOOTHER_ALL && (smootherOutput & SMOOTHER_DISTURBANCE) != 0) {
    ...
    private static SmootherResult prepareResult(SmootherResult target,
        ...
        private static SmootherResult smoothConventional(StateSpaceModel stateSpace,
                                                         StateSpaceModel observationModel,
                                                         FilterResult fr,
        ...
        double[] smoothingError = (storeAuxiliary || doDisturbance)
                ? (storeAuxiliary ? result.smoothingError : (reuseResult ? scratch : new double[kEndog]))
                : null;
        ...
        for (int t = nobs - 1; t >= 0; t--) {
                ...
                if (smoothingError != null) {
                        ...
                        if (ke < kEndog) {
                                System.arraycopy(smoothingError, smoothingErrorOff, scratch, tmpRqBase, ke);
        ...
        private static SmootherResult smoothClassical(StateSpaceModel stateSpace,
                                                      StateSpaceModel observationModel,
                                                      FilterResult fr,
                                                      Pool pool, int smootherOutput,
                                                      boolean reuseResult,
        ...
        private static SmootherResult smoothAlternative(StateSpaceModel stateSpace,
                                                        StateSpaceModel observationModel,
                                                        FilterResult fr,
                                                        Pool pool, int smootherOutput,
                                                        boolean reuseResult,
        ...
        private static SmootherResult smoothDiffuse(StateSpaceModel stateSpace,
                                                    StateSpaceModel observationModel,
                                                    FilterResult fr,
                                                    Pool pool, int smootherOutput,
                                                    boolean reuseResult,
        ...
        private static SmootherResult smoothUnivariate(StateSpaceModel stateSpace,
                                                       StateSpaceModel observationModel,
                                                       FilterResult fr,
                                                       Pool pool, int smootherOutput,
                                                       boolean reuseResult,
        ...
        private static void requireRealInputs(StateSpaceModel stateSpace,
                                              StateSpaceModel observationModel) {
                StateSpaceModelSupport.requireRealStorage(stateSpace, "stateSpace");
                StateSpaceModelSupport.requireRealStorage(observationModel, "observationModel");
        }

        private static void copyObservedRows(StateSpaceModel observationModel,
                                             int t,
                                             double[] source,
                                             int sourceOffset,
                                             int sourceLd,
        ...
        private static void copyObservedColumns(StateSpaceModel observationModel,
                                                int t,
                                                int rowCount,
                                                double[] source,
                                                int sourceOffset,
        ...
        private static void copyObservedVector(StateSpaceModel observationModel,
                                               int t,
                                               double[] source,
                                               int sourceOffset,
                                               double[] target,
        ...
        private static void copyObservedSquareMatrix(StateSpaceModel observationModel,
                                                     int t,
                                                     double[] source,
                                                     int sourceOffset,
                                                     int sourceLd,
        ...
        private static void scatterObservedVector(StateSpaceModel observationModel,
                                                  int t,
                                                  double[] source,
                                                  int sourceOffset,
                                                  double[] target,
        ...
        private static void scatterObservedSquareMatrix(StateSpaceModel observationModel,
                                                        int t,
                                                        double[] source,
                                                        int sourceOffset,
                                                        int sourceLd,
