...
abstract class SmootherResultBase<T extends SmootherResultBase<T>> implements Cloneable {
    ...
    public double[] smoothedStateAutocovariance;
    ...
    private int smoothedStateAutocovarianceBase;
    private int smoothedStateAutocovarianceLength;
    ...
    protected SmootherResultBase() {
        ...
        this.smoothedStateAutocovariance = EMPTY;
    ...
    protected SmootherResultBase(int kEndog, int kStates, int kPosdef, int nobs, SmootherResultLayout layout) {
        ...
        int stateAutocovLength = layout.smoothedStateAutocovarianceLength();
        ...
        setSurface(10, stateAutocovLength > 0 ? new double[stateAutocovLength] : EMPTY, 0, stateAutocovLength);
    ...
    final T reuseDiffuseAuxiliary(double[] backing, SmootherDiffuseLayout diffuseLayout) {
        return reuseDiffuseAuxiliary(backing, 0, diffuseLayout);
    }

    final T reuseDiffuseAuxiliary(double[] backing, int backingBase, SmootherDiffuseLayout diffuseLayout) {
        setDiffuseSurface(0,
            diffuseLayout.diffuseEstimatorLength() == 0 ? EMPTY : backing,
            backingBase + diffuseLayout.diffuseEstimatorBase(),
            diffuseLayout.diffuseEstimatorLength());
        setDiffuseSurface(1,
            diffuseLayout.diffuse1EstimatorCovLength() == 0 ? EMPTY : backing,
            backingBase + diffuseLayout.diffuse1EstimatorCovBase(),
            diffuseLayout.diffuse1EstimatorCovLength());
        setDiffuseSurface(2,
            diffuseLayout.diffuse2EstimatorCovLength() == 0 ? EMPTY : backing,
            backingBase + diffuseLayout.diffuse2EstimatorCovBase(),
    ...
    public final T copy() {
        ...
        ResultArrays.copySurface(smoothedStateAutocovariance, smoothedStateAutocovarianceBase(), smoothedStateAutocovarianceLength(),
            copy.smoothedStateAutocovariance, copy.smoothedStateAutocovarianceBase());
    ...
    private SmootherResultLayout currentLayout() {
        return SmootherResultLayout.create(
            ...
            smoothedStateAutocovarianceLength() > 0,
    ...
    public final void suppressStateAutocovariance() {
        setSurface(10, EMPTY, 0, 0);
    }
    ...
    final T trimOutputMask(int smootherOutput) {
        ...
        if ((smootherOutput & KalmanSmoother.SMOOTHER_STATE_AUTOCOV) == 0) {
            suppressStateAutocovariance();
        }
        ...
        if (!KalmanSmoother.storesAuxiliary(smootherOutput)) {
            suppressAuxiliary();
    ...
    public final int smoothedStateAutocovarianceBase() {
        return smoothedStateAutocovarianceBase;
    }

    public final int smoothedStateAutocovarianceLength() {
        return smoothedStateAutocovarianceLength;
    }

    public final int smoothedStateAutocovarianceOffset(int t) {
        return smoothedStateAutocovarianceBase() + t * kStates * scalarWidth() * kStates;
    }
    ...
    private void bind(int kEndog, int kStates, int kPosdef, int nobs,
        ...
        setSurface(10, layout.smoothedStateAutocovarianceLength() == 0 ? EMPTY : backing,
            layout.smoothedStateAutocovarianceBase(), layout.smoothedStateAutocovarianceLength());
    ...
    final void setSurface(int index, double[] surface, int base, int length) {
        ...
        switch (index) {
            ...
            case 10 -> {
                smoothedStateAutocovariance = assigned;
                smoothedStateAutocovarianceBase = assignedBase;
                smoothedStateAutocovarianceLength = assignedLength;
            }
