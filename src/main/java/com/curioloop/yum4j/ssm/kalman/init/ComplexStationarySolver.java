...
final class ComplexStationarySolver {
    ...
    private static boolean solveCovViaRealEmbedding(KalmanSSM stateSpace,
                                                    int t,
                                                    double[] target,
                                                    int targetOffset,
                                                    int targetLd) {
    ...
    private static boolean solveMeanViaRealEmbedding(KalmanSSM stateSpace,
                                                     int t,
                                                     double[] target,
                                                     int targetOffset) {
        int kStates = stateSpace.stateCount();
    ...
    private static boolean covarianceResidualWithinTolerance(KalmanSSM stateSpace,
                                                            int t,
                                                            double[] stationaryBacking,
                                                            int workspaceOffset,
                                                            int expectedOffset,
