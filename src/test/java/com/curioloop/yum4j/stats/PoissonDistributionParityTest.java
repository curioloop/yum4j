...
class PoissonDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/poisson-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        PoissonDistributionParityFixture fixture = ParityFixtureLoader.load(FIXTURE_PATH, PoissonDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(PoissonDistributionCase testCase) {
        PoissonDistribution distribution = new PoissonDistribution(testCase.lambda);
    ...
    public static final class PoissonDistributionParityFixture {
        public FixtureMeta meta;
        public List<PoissonDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class PoissonDistributionCase {
        public String name;
