...
class GeometricDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/geometric-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        GeometricDistributionParityFixture fixture = ParityFixtureLoader.load(FIXTURE_PATH, GeometricDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(GeometricDistributionCase testCase) {
        GeometricDistribution distribution = new GeometricDistribution(testCase.successFraction);
    ...
    public static final class GeometricDistributionParityFixture {
        public FixtureMeta meta;
        public List<GeometricDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class GeometricDistributionCase {
        public String name;
