...
class TriangularDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/triangular-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        TriangularDistributionParityFixture fixture = ParityFixtureLoader.load(FIXTURE_PATH, TriangularDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(TriangularDistributionCase testCase) {
        TriangularDistribution distribution = new TriangularDistribution(testCase.lower, testCase.mode, testCase.upper);
        ...
        assertClose(testCase.name + " mode", testCase.modeValue, distribution.mode(), testCase.tolerance);
    }
    ...
    public static final class TriangularDistributionParityFixture {
        public FixtureMeta meta;
        public List<TriangularDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class TriangularDistributionCase {
        public String name;
        public double lower;
        public double mode;
        public double upper;
