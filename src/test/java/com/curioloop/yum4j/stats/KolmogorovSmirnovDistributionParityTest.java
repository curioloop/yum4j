...
class KolmogorovSmirnovDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/kolmogorov-smirnov-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        KolmogorovSmirnovDistributionParityFixture fixture = ParityFixtureLoader.load(FIXTURE_PATH, KolmogorovSmirnovDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(KolmogorovSmirnovDistributionCase testCase) {
        KolmogorovSmirnovDistribution distribution = new KolmogorovSmirnovDistribution(testCase.numberOfObservations);
    ...
    public static final class KolmogorovSmirnovDistributionParityFixture {
        public FixtureMeta meta;
        public List<KolmogorovSmirnovDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class KolmogorovSmirnovDistributionCase {
        public String name;
