...
class RayleighDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/rayleigh-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        RayleighDistributionParityFixture fixture = ParityFixtureLoader.load(FIXTURE_PATH, RayleighDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(RayleighDistributionCase testCase) {
        RayleighDistribution distribution = new RayleighDistribution(testCase.sigma);
    ...
    public static final class RayleighDistributionParityFixture {
        public FixtureMeta meta;
        public List<RayleighDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class RayleighDistributionCase {
        public String name;
        public double sigma;
        public double x;
        public double pdf;
