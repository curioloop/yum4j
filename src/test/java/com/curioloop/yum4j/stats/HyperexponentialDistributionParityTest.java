...
class HyperexponentialDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/hyperexponential-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        HyperexponentialDistributionParityFixture fixture =
            ParityFixtureLoader.load(FIXTURE_PATH, HyperexponentialDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(HyperexponentialDistributionCase testCase) {
        ...
        assertClose(testCase.name + " upper-tail quantile", testCase.x,
    ...
    public static final class HyperexponentialDistributionParityFixture {
        public FixtureMeta meta;
        public List<HyperexponentialDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class HyperexponentialDistributionCase {
        public String name;
