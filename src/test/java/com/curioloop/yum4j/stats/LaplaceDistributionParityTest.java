...
class LaplaceDistributionParityTest {

    private static final String FIXTURE_PATH = "boost/math/laplace-distribution-boost-parity-fixture.json";

    @TestFactory
    Stream<DynamicTest> boostReferenceValuesMatch() {
        LaplaceDistributionParityFixture fixture = ParityFixtureLoader.load(FIXTURE_PATH, LaplaceDistributionParityFixture.class);
        return fixture.cases.stream().map(testCase -> dynamicTest(testCase.name, () -> assertCase(testCase)));
    }

    private static void assertCase(LaplaceDistributionCase testCase) {
        LaplaceDistribution distribution = new LaplaceDistribution(testCase.location, testCase.scale);
    ...
    public static final class LaplaceDistributionParityFixture {
        public FixtureMeta meta;
        public List<LaplaceDistributionCase> cases = Collections.emptyList();
    }
    ...
    public static final class LaplaceDistributionCase {
        public String name;
